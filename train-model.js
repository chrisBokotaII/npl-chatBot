// this package is used to train a NLP model for chatbot
const { NlpManager } = require("node-nlp");
// here we are creating  a new instance of NlpManager class .
// it is used to train a NLP model and it takes two parameters languages and forceNER
// languages is an array of languages to train the model for.
// forceNER is a boolean indicating whether to force NER or not.
const manager = new NlpManager({ languages: ["en"], forceNER: true });
// here we are adding the documents to the model
...
manager.addDocument("en", "I need help", "user.needsadvice");
